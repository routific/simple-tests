...
const CHANGELOG = [
  {
    ...
    changes: [
      ...
      "Create Test Run: add folder tree sidebar to test case selection — browse cases by folder hierarchy instead of only searching, matching the repository view",
    ],
  },
  {
    version: "5506f82",
  ...
  },
  {
    ...
    date: "2026-03-26",
    changes: [
      "Spawn bug tickets in Linear directly from failed test scenarios — creates a sub-issue with 'Bug' label, Gherkin steps, notes, and uploaded screenshots",
      "Auto-prompt modal when marking a test as failed (on runs linked to a Linear issue)",
      "Bug ticket links displayed inline on failed test results",
      "Screenshots uploaded to Linear's cloud storage and embedded as images in bug tickets",
    ],
  },
  {
    version: "660e7ee",
  ...
  },
  {
    ...
    date: "2026-03-26",
    changes: [
      "Drag and drop to reorder scenarios in test run edit mode",
    ],
  },
  {
    version: "9d80a1e",
  ...
  },
  {
    ...
    date: "2026-03-12",
    changes: [
      "Fix release deeplinks opening the wrong release or showing invalid slugs",
    ],
  },
  {
    version: "a010772",
  ...
  },
  {
    ...
    date: "2026-03-09",
    changes: [
      "Multiple selected test cases can now be moved together via drag & drop",
    ],
  },
  {
    version: "88d2546",
  ...
  },
  {
    ...
    date: "2026-03-09",
    changes: [
      "Show already-added test cases and scenarios when adding to a run, making it easier to add new scenarios to existing test cases",
    ],
  },
  {
    version: "4b1e9ae",
